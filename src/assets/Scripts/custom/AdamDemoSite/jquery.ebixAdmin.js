/* 
  Author: Ebix Software Pvt. Ltd.
*/

;(function($) {	
    // Using it without an object
    $.ebixAdmin = function(options) { return $.fn.ebixAdmin(options); };
    
    $.fn.ebixAdmin = function(options) { 
        ...
        if(settings.showThemer) {
            ...
            $('#themerBtn').click(function() {
                if($(this).hasClass('open-notuse')) {
                    //close themer
                    $('#themer').css('right', '-200px');
                    $(this).removeClass('open-notuse');
                } else {
                    //open-notuse themer
                    $('#themer').css('right', '0px');
                    $(this).addClass('open-notuse');
                }
            });
       ...
       function setCurrentNav () {
        ...
        function resBtn () {
            $('#header .nav-no-collapse').append('<a href="#" id="resBtn" class="btn btn-success"><i class="fa fa-bars"></i></a>');
            resBtnClick();
        }
